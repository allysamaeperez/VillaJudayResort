		...
		<form action="<?= base_url() ?>payment_type/edit/<?=$payment_type->payment_type?>" method="post">
			...
			<div class="add-fields">
				...
				<div class="field">
					...
					<input type="number" min="1" id="price" name="price" required value="<?=$payment_type->payment_price?>" placeholder="Price"/>
					<i icon="icon-dollar"></i>
				</div> <!-- /field -->

				<div class="field">
					<label for="details">Details:</label>
					<input type="text" id="details" name="details" value="<?=$payment_type->payment_details?>" placeholder="Details"/>
				</div> <!-- /field -->
